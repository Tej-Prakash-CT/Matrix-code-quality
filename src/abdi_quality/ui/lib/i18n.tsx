...
const en: Dict = {
  ...
  "report.section.prDetail": "Scan Detail",
  ...
  "report.gradeBreakdown.intro":
    "Each dimension contributes score × weight. The sum maps to a letter grade (A ≥ 95, B ≥ 85, C ≥ 70, D ≥ 50, E < 50). Failing scans are floored at grade {cap}, so a failing scan can never be Excellent or Good.",
  ...
  "report.gradeBreakdown.failCapBody":
    "Weighted score is {total} (would be grade {base}), but this scan is failing — grade floored to {cap}.",
};
...
const ja: Dict = {
  ...
  "report.section.prDetail": "スキャン詳細",
  ...
  "report.gradeBreakdown.failCapBody":
    "加重スコアは {total} （本来は グレード {base}）ですが、このスキャンは失敗のため、グレードを {cap} に制限しました。",
};
